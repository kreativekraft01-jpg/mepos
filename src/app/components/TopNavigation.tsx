...
import { SearchResults, type CustomerResult, type BoxResult, type OrderResult } from './SearchResults';
        ...
        <div className="flex-[2] min-w-0" ref={searchContainerRef}>
          <div className="relative">
            ...
            <input
              ...
              placeholder={isCustomerSearchActive ? 'Search customers...' : 'Search box, customer or order'}
          ...
          {showSearchResults && (
            <div className="relative">
              <SearchResults 
                ...
                boxes={boxes}
                orders={orders}
                customersOnly={isCustomerSearchActive}

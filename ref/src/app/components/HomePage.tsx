        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col gap-6 h-full min-h-0">
          ...
          <div className="grid grid-cols-2 gap-4 flex-1 min-h-0">
             <motion.button
                ...
                className="col-span-2 lg:col-span-1 lg:row-span-2 group relative bg-primary text-primary-foreground p-8 flex flex-col items-start justify-between hover:brightness-110 transition-all rounded-[4px] overflow-hidden border border-transparent hover:border-primary-foreground/10"
              >
                ...
                <motion.div 
                  ...
                  className="p-4 rounded-none mb-8 relative z-10"
                >
                  <FileText className="w-10 h-10" strokeWidth={1} />
                </motion.div>
                
                <div className="relative z-10 w-full">
                   <span className="text-4xl font-light block mb-2 tracking-tight">New<br/>Transaction</span>
                   <div className="h-px w-12 bg-primary-foreground/50 mb-4 group-hover:w-24 transition-all duration-500" />
              ...
              <motion.button
                ...
                className="group relative bg-card border border-border p-6 flex flex-col items-start justify-between transition-all rounded-[4px] hover:border-primary/50 hover:shadow-lg"
              >
                 ...
                 <motion.div 
                   whileHover={{ x: 5 }}
                   className="p-3 rounded-none mb-4 group-hover:text-primary transition-colors"
                 >
                    <UserPlus className="w-6 h-6" strokeWidth={1.5} />
                 </motion.div>
                 <div>
                   <span className="text-lg font-medium block">New Customer</span>
              ...
              >
                 ...
                 <div className="text-left">
                   <span className="text-lg font-medium block">Current Transaction</span>
